          ...
          <div class="card">
            <div class="card-body">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered" id="borderedTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#bordered-profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Marcas</button>
                </li>
                <li class="nav-item" role="presentation">
              ...
              <div class="tab-content pt-2" id="borderedTabContent">
                <div class="tab-pane fade show active" id="bordered-home" role="tabpanel" aria-labelledby="home-tab">
                  <?php require_once '../views/equipos.php' ?>
                </div>
                <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="profile-tab">
                    <?php require_once '../views/marcas.php' ?>
                </div>
